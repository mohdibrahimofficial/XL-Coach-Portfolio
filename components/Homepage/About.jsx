...
const About = () => {
  return (
    <div id="about" className="bg-black py-24 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-bold text-white mb-6 tracking-wider">ABOUT ME</h2>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-3/5">
            <h3 className="text-3xl font-bold text-white mb-8 tracking-wide">TRANSFORMING LIVES THROUGH COACHING</h3>
            ...
            <div className="grid grid-cols-2 gap-6 mt-12">
              <div className="border-l-4 border-white pl-6 py-4">
                <h4 className="font-bold text-white text-2xl tracking-wider">1000+</h4>
                <p className="text-gray-400 mt-2">Clients Coached</p>
              </div>
              <div className="border-l-4 border-white pl-6 py-4">
                <h4 className="font-bold text-white text-2xl tracking-wider">10+</h4>
                <p className="text-gray-400 mt-2">Years Experience</p>
              </div>
              <div className="border-l-4 border-white pl-6 py-4">
                <h4 className="font-bold text-white text-2xl tracking-wider">98%</h4>
                <p className="text-gray-400 mt-2">Success Rate</p>
              </div>
              <div className="border-l-4 border-white pl-6 py-4">
                <h4 className="font-bold text-white text-2xl tracking-wider">50+</h4>
                <p className="text-gray-400 mt-2">Workshops</p>
              </div>
            </div>
            
            <div className="mt-12">
              <button className="bg-white text-black border-2 border-white hover:bg-transparent hover:text-white transition-all duration-300 font-semibold py-3 px-8 rounded-full tracking-wider">
                DOWNLOAD MY BIO
              </button>
            </div>
          </div>
